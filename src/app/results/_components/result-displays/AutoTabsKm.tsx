...
import TeamResultsKm from './TeamResultsKm';
...
export default function AutoTabsKm({ categories, timerDelayDefault, pageSize, participantResults }: AutoTabsProps) {
    ...
    <div className="relative px-4 text-center">
      <Tabs value={activeTab} className="flex w-full justify-center py-4" onValueChange={setActiveTab}>
        ...
        <TabsContent value={activeTab}>
          <TeamResultsKm data={paginatedData} isLoading={false} />
        </TabsContent>
      </Tabs>
    </div>
  );
